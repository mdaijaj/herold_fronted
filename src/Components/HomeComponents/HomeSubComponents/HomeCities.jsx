...
import { HomeCitiesNav } from "./HomeCitiesComponents/HomeCitiesNav";
import AppContext from "../../../AppContext";
import { HomeCitiesMain } from "./HomeCitiesComponents/HomeCitiesMain";
import { HomeCitiesFoot } from "./HomeCitiesComponents/HomeCitiesFoot";
...
export const HomeCities = () => {
    const { setZipCodeList, setCityContent, setIndustryAZList, setGradimoAdviceNow, productIdList, setCompanyList, setSugCityList, setSugDistrictList, setCityList, setProductsList, counselerList, setCounselerIdList, counselerIdList, baseBackendRoute, setProductIdList, productsList, setCounselerList } = useContext(AppContext);
    ...
    useEffect(() => {
        ...
        const getSpecificCityContent = async () => {
            try {
                await axios.get(`${baseBackendRoute}/api/v1/companies/top-industry-list-on-city/${id}/`)
                    .then((res) => {
                        console.log(res);
