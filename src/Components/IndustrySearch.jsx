    ...
    useEffect(() => {
        ...
        if (open) {
            ...
            const handleCompanySearch = async () => {
                await axios.get(`${baseBackendRoute}/api/v1/companies/company-search/?industry_query=${encodeURIComponent(industry)}&address_query=${encodeURIComponent(city)}&is_opening=${encodeURIComponent(open)}`)
                    .then((res) => {
                        console.log(res);
            ...
            const handleCompanySearch = async () => {
                await axios.get(`${baseBackendRoute}/api/v1/companies/company-search/?industry_query=${encodeURIComponent(industry)}&address_query=${encodeURIComponent(city)}`)
                    .then((res) => {
                        console.log("here");
                        console.log(res);
                        setSpecificIndustryList(res.data);
        ...
        const getCompanyNameOnly = async () => {
        ...
        const getCityOnly = async () => {
            await axios.get(`${baseBackendRoute}/api/v1/companies/company-search/?address_query=${encodeURIComponent(city_only)}/`)
                .then((res) => {
                    console.log(res);
                    setCompanyNameOnly(res.data);
                })
