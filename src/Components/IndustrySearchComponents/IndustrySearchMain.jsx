...
export const IndustrySearchMain = () => {
    const [first, setFirst] = useState(true);
    const [second, setSecond] = useState(false);
    const { industry, city } = useParams();
    const [show, setShow] = useState(false);
    const [third, setThird] = useState(false);
    const { specificIndustryList, baseBackendRoute, industryAZList, randomIndustries, specificIndustryCompanyList, specificIndustryCityList, companyNameOnly, cityOnly } = useContext(AppContext);
    useEffect(() => {
        // console.log(specificIndustryList);
        // console.log(specificIndustryList.length);
        // console.log(specificIndustryCityList);
        console.log("industry below:");
        console.log(industryAZList);
        console.log(Object.values(industryAZList).flat())
        console.log(specificIndustryCompanyList);
    }, [specificIndustryList, specificIndustryCompanyList, specificIndustryCityList, industryAZList])
    return (
        <>
                                        ...
                                        specificIndustryList ?
                                                                        ...
                                                                        <div className="yellow-pages-search-result-item_wrapper__HmB1A">
                                                                            ...
                                                                            >
                                                                                <a
                                                                                    ...
                                                                                    href={`${baseBackendRoute}${data.logo}`}
                                                                                >
                                                                                    <div
                                                                                        style={{
                                                                                            display: "block",
                                            ...
                                            companyNameOnly ?
                                                ...
                                                <div>
                                                    ...
                                                    >
                                                        {
                                                            companyNameOnly?.map((data, index) => (
                                                                <div
                                                                    id="plain0"
                                                                    className="yellow-pages-search-result-items_child__3rYWL"
                                                                >
                                                                                                        ...
                                                                                                        <div className="rating_element_stars__13C_C">
                                                                                                            {
                                                                                                                Array.from({ length: Number(data.avg_rating) }).map((_, ind) => (
                                                                                                                    <div className="rating_element_star__OZewC">
                                                                                                                        <div class="input-group-icon">
                                                                                                                            <img src="/gradimo_icons/star-filled.png" width="25px" height="25px" alt="down" />
                                                                                                                        </div>                                                                                                                    </div>
                                                                                                                ))
                                                                                                            }
                                                                                                        </div>
                                                                                ...
                                                                                >
                                                                                    <div className="details-page-section-heading_element_details_page_section_heading_element__2R4ba details-page-section-heading_element_small__3gZgh details-page-section-heading_element_without_border__1RvBf">
                                                                                        <div className="details-page-section-heading_element_inner__2Ef9j">
                                                                                            <div className="details-page-section-heading_element_icon__2GqOs">
                                                                                                <div class="input-group-icon">
                                                                                                    <img src="/gradimo_icons/locationpin.png" width="25px" height="25px" alt="down" />
                                                                                                </div>                                                                                            </div>
                                                                                            <h2 className="details-page-section-heading_element_heading__3UmDR">
                                                                                                <font style={{ verticalAlign: "inherit" }}>
                                                                                                    <font style={{ verticalAlign: "inherit" }}>
                                                                                    ...
                                                                                    <div className="business-address_button_wrapper__38hR4">
                                                                                        <a data-yxt="phn" title="+43 5273 204985">
                                                                                            ...
                                                                                            >
                                                                                                <div>
                                                                                                    <div class="input-group-icon">
                                                                                                        <img src="/gradimo_icons/phone.png" width="25px" height="25px" alt="down" />
                                                                                                    </div>                                                                                                </div>
                                                                                                <div className="phoneWrapper">
                                                                                                    <span>
                                                                                                        <font style={{ verticalAlign: "inherit" }}>
                                        ...
                                        <div className="card-wrapper_element_card_wrapper_element__Bj1_s">
                                            <div className="details-page-section-heading_element_details_page_section_heading_element__2R4ba">
                                                <div className="details-page-section-heading_element_inner__2Ef9j">
                                                    <div className="details-page-section-heading_element_icon__2GqOs">
                                                        <div class="input-group-icon">
                                                            <img src="/gradimo_icons/industry.png" width="25px" height="25px" alt="down" />
                                                        </div>                                                    </div>
                                                    <h2 className="details-page-section-heading_element_heading__3UmDR">
                                                        <font style={{ verticalAlign: "inherit" }}>
                                                            <font style={{ verticalAlign: "inherit" }}>
