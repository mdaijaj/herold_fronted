...
export const AboutEditorNav = () => {
    ...
    const { setNavSelect, setFilteredEditorIdList, filteredEditorIdList, editorList, setFilteredEditorList, productsList, counselerList, editorIdList } = useContext(AppContext);
    useEffect(() => {
        console.log(menu_1);
        console.log(editorIdList);
        ...
        const randomThreeExcept = async (list, excludedValue) => {
            ...
            if (filteredList.length >= 2) {
                ...
                setFilteredEditorIdList(shuffledList);
            }
        }
        randomThreeExcept(editorIdList, edit);




    }, [menu_1, menu_2, menu_3, editorIdList, mobileToggle])
    return (
        <>
