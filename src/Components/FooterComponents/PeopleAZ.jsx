...
import { PeopleAZNav } from "./PeopleAZComponents/PeopleAZNav";
import { FooterSection } from "../FooterSection";
import { PeopleAZMain } from "./PeopleAZComponents/PeopleAZMain";
import { NavigationBar } from "../NavigationBar";



export const PeopleAZ = () => {
    const [isMobileMenuOpen, setMobileMenuOpen] = useState(false);
    const [windowWidth, setWindowWidth] = useState(window.innerWidth);
    const { people } = useParams();
    const { setPeopleAZList, setCompanyList, setSugCityList, setSugDistrictList, cookies, setCompanyPersonalInfo, setIndustryAZList, setCityContent, productIdList, setCityList, setProductsList, counselerList, setCounselerIdList, counselerIdList, baseBackendRoute, setProductIdList, productsList, setCounselerList } = useContext(AppContext);
