...
import { PeopleAZActiveMain } from "./PeopleAZActiveComponents/PeopleAZActiveMain";
...
export const PeopleAZActive = () => {
    ...
    useEffect(() => {
        ...
        const getSpecificPeople = async () => {
            await axios.get(`${baseBackendRoute}/api/v1/companies/people-detail/${people}/`)
                .then((res) => {
                    console.log(res);
