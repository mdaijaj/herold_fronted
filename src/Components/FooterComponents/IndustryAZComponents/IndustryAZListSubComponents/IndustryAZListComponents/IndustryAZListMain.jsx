...
export const IndustryAZListMain = () => {
    const [first, setFirst] = useState(true);
    const [second, setSecond] = useState(false);
    const { industry } = useParams();
    const [show, setShow] = useState(false);
    const [third, setThird] = useState(false);
    const { specificIndustryList, baseBackendRoute, randomIndustries, specificIndustryCompanyList, industryAZList, specificIndustryCityList } = useContext(AppContext);
    useEffect(() => {
        console.log(specificIndustryCompanyList);
        console.log(industryAZList);
        console.log(Object.values(industryAZList).flat());

    }, [specificIndustryList, specificIndustryCityList, specificIndustryCompanyList, industryAZList])
    return (
        <>
                                    ...
                                    <div className="list-header_heading__AMXVc">
                                        <h4 className="list-header_head__28oEb">
                                            <font style={{ verticalAlign: "inherit" }}>
                                                <font style={{ verticalAlign: "inherit" }}>
                                                    {specificIndustryList?.count} results found for {industry}
                                                </font>
                                            </font>
                                        </h4>
                                            ...
                                            <div className="list-header_filter__3yvFJ list-header_layout_filter__1sdRZ">
                                                ...
                                                <ul>
                                                    ...
                                                    >
                                                        <a title="list">
                                                            <div class="input-group-icon">
                                                                <img src="/gradimo_icons/list.png" alt="list" style={{ height: '100%', width: '100%', objectFit: 'cover' }} />
                                                            </div>
                                                            <span>
                                                                <font style={{ verticalAlign: "inherit" }}>
                                                                    <font style={{ verticalAlign: "inherit" }}>
                                                    ...
                                                    >
                                                        <a title="Tiles">
                                                            <div class="input-group-icon">
                                                                <img src="/gradimo_icons/tile.png" width="25px" height="25px" alt="tile" style={{ paddingTop: '10px' }} />
                                                            </div>
                                                            <span>
                                                                <font style={{ verticalAlign: "inherit" }}>
                                                                    <font style={{ verticalAlign: "inherit" }}>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="breadcrumb_right_arrow__CSjEg">
                                        <div class="input-group-icon">
                                            <img src="/gradimo_icons/right-arrow.png" width="15px" height="15px" alt="right-arrow" style={{ marginTop: '10px' }} />
                                        </div>                                        </div>
                                </li>
                                <li
                                ...
                                >
                                    ...
                                    <span itemProp="name">
                                        <font style={{ verticalAlign: "inherit" }}>
                                            <font style={{ verticalAlign: "inherit" }}>{specificIndustryList?.industry?.industry_name}</font>
                                        </font>
                                    </span>
                                </li>
                            </ol>
                            ...
                            >
                                ...
                                <div className={first ? "left" : second ? "left full_width" : "left"}>
                                                    ...
                                                    <div className="list-header_filter__3yvFJ list-header_layout_filter__1sdRZ">
                                                        ...
                                                        <ul>
                                                            ...
                                                            >
                                                                <a title="list">
                                                                    <div class="input-group-icon">
                                                                        <img src="/gradimo_icons/list.png" width="25px" height="25px" alt="list" style={{ marginTop: '6px' }} />
                                                                    </div>                                                                    <span>
                                                                        <font style={{ verticalAlign: "inherit" }}>
                                                                            <font style={{ verticalAlign: "inherit" }}>
                                                                                list
                                                            ...
                                                            >
                                                                <a title="Tiles">
                                                                    <div class="input-group-icon">
                                                                        <img src="/gradimo_icons/tile.png" width="25px" height="25px" alt="tile" style={{ marginTop: '6px' }} />
                                                                    </div>                                                                        <span>
                                                                        <font style={{ verticalAlign: "inherit" }}>
                                                                            <font style={{ verticalAlign: "inherit" }}>
                                                                                Tiles
                                    ...
                                    <div>
                                        ...
                                        >
                                            {
                                                specificIndustryList?.companies?.map((data, index) => (
                                                    <div
                                                        id="plain0"
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <div
                                                                ...
                                                                itemType="https://schema.org/ListItem"
                                                                data-uid={315349}
                                                                data-detail-url={`/company-az/active/${data.slug}`}
                                                                data-clickpos="whitespace"
                                                            >
                                                                <meta content={1} itemProp="position" />
                                                                <meta
                                                                    content={`/company-az/active/${data.slug}`}
                                                                    itemProp="url"
                                                                />
                                                                <div className="yellow-pages-search-result-item_wrapper__HmB1A">
                                                                    ...
                                                                    >
                                                                        ...
                                                                        >
                                                                            ...
                                                                            >
                                                                                <img
                                                                                    title={`LOGO ${data.company_}`}
                                                                                    alt={`LOGO ${data.company_}`}
                                                                                    sizes="100vw"
                                                                                    srcSet={`${baseBackendRoute}${data.logo}`}
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <div className="business-address_button_wrapper__38hR4">
                                                                            <a data-yxt="phn" title={`+tel:${data.phone_number}`} href="#">
                                                                                ...
                                                                                >
                                                                                    <div>
                                                                                        <div class="input-group-icon">
                                                                                            <img src="/gradimo_icons/phone.png" width="20px" height="20px" alt="phone" style={{ marginRight: '10px' }} />
                                                                                        ...
                                                                                        <span>
                                                                                            <font style={{ verticalAlign: "inherit" }}>
                                                                                                <font
                                                                                                    style={{ verticalAlign: "inherit" }}
                                                                                                >
                                                                                                    {show ? data.phone_number : "Show phone number"}
                                                                                                </font>
                                                                                            </font>
                                                                                        </span>
                                                                                    </div>
