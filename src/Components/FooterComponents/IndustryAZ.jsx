...
import { IndustryAZSearch } from "./IndustryAZComponents/IndustryAZSearch";
import { IndustrAZBreadcrumb } from "./IndustryAZComponents/IndustryAZBreadcrumb";
import { IndustryAZSections } from "./IndustryAZComponents/IndustryAZSections";
import AppContext from "../../AppContext";
import axios from "axios";
import { IndustryAZNav } from "./IndustryAZComponents/IndustryAZNav";

export const IndustryAZ = () => {
    const { setZipCodeList, setIndustryAZList, setGradimoAdviceNow, setCityContent, productIdList, setCompanyList, setSugCityList, setSugDistrictList, setCityList, setProductsList, counselerList, setCounselerIdList, counselerIdList, baseBackendRoute, setProductIdList, productsList, setCounselerList } = useContext(AppContext);
