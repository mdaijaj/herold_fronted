...
export const CompanyAZMain = () => {
    ...
    const { baseBackendRoute, companyAZList, sugDistrictList, zipCodeList, industryAZList, setSpecificIndustryList, sugCityList, companyList, setIndustryCompaniesList, setIndustryAZList } = useContext(AppContext);
 ...
 const currentItems = companyAZList?.[alpha]?.slice(indexOfFirstItem, indexOfLastItem) || [];

 // Calculate total number of pages
 const totalPages = Math.ceil((companyAZList?.[alpha]?.length || 0) / itemsPerPage);
 ...
 const handlePageChange = (page) => {
    ...
    useEffect(() => {
        console.log(companyAZList);
        console.log(companyAZList?.[alpha])
    }, [companyAZList])
    return (
        <>
                        ...
                        <div class="home-search_search_container__3B3KX">
                            <div class="home-search_search_controls_wrapper__T3bc6">
                                <div>
                                    ...
                                    <h6 class="alphabatical-search-heading" _msttexthash="313846" _msthash="36">Search by alphabet {alpha}</h6>
                                    <div class="mb_10">
                                        <ul class="AZFilter_wrapper__WeA8t">
                                            {
                                                Alphabets?.map((data, index) => (
                                                    <li className={data === alpha ? "AZFilter_page_item__9Nt-2 AZFilter_active__1a7Xd" : "AZFilter_page_item__9Nt-2"}>
                                                        <a class="AZFilter_page_link__F6GSB" href={`/company-az/${data}`} _msttexthash="5915" _msthash="37">{data}</a>
                                                    </li>
                                                ))
                                            }
                                        </ul>
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="breadcrumb_right_arrow__CSjEg">
                                    <div class="input-group-icon">
                                        <img src="/gradimo_icons/temp-right.png" alt="temp-right" width={"15px"} height={"15px"} style={{ marginTop: '10px' }} />
                                    </div>
                                </div>
                            </li>
                            <li
                            ...
                            >
                                ...
                                <div className="breadcrumb_right_arrow__CSjEg">
                                    <div class="input-group-icon">
                                        <img src="/gradimo_icons/temp-right.png" alt="temp-right" width={"15px"} height={"15px"} style={{ marginTop: '10px' }} />                                                                </div>                                </div>
                            </li>
                            <li
                            ...
                            >
                                ...
                                <span itemProp="name">
                                    ...
                                    <font style={{ verticalAlign: "inherit" }}>{alpha}</font>
                                </span>
                            </li>
                        </ol>
                    </div>
                ...
                <div className="container">
                    <h2 className="az-pages_az_heading__3qBsX">
                        <font _mstmutation="1" _msttexthash="1166295" _msthash="66">
                            All companies starting with the letter {alpha}
                        </font>
                    </h2>
                    <ul className="az-list_element_col_list__2bXWf az-list_element_two_col_list__vtmD6">
                        {currentItems.map((data, index) => (
                            <li key={index} className="az-list_element_list_item__mkJ9F">
                                <a
                                    title={`${alpha} - ${data.company_name}`}
                                    href={`/company-az/active/${data.slug}/`}
                                >
                                    <font style={{ verticalAlign: "inherit" }}>
                                        <font style={{ verticalAlign: "inherit" }}>
                                            {alpha} - {data.company_name}
                                        </font>
                                    </font>
                                </a>
                            </li>
