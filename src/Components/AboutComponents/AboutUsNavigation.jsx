...
export const AboutUsNavigationBar = () => {
    ...
    useEffect(() => {
        console.log(menu_1);
    }, [menu_1, menu_2, menu_3, mobileToggle, productsList])
    return (
        <>
            <header id="masthead" class="site-header">
                <nav class={mobileToggle ? "nav-mobile opened" : "nav-mobile"}>
                    ...
                    <div class="container-1 container-1-inner">
                        <ul id="primary-menu" class="nav-category">
                            ...
                            <li id="menu-item-54512" className={menu_3 ? "menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-74445 active" : "menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-74445"}>
                            ...
                            <li id="menu-item-74418" class="current-menu-item menu-item menu-item-type-post_type menu-item-object-page menu-item-home page_item page-item-53318 current_page_item menu-item-has-children menu-item-54512">
                ...
                <nav class="nav-desktop">
                    <div class="container-1">
                        ...
                        <ul id="primary-menu" class="nav-category" style={{ border: '0px' }} >
                            ...
                            <li onMouseEnter={() => { setMenu_3(false); setMenu_1(false); setMenu_2(true); }} class={menu_2 ? "menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-74445 current-hover-active active" : "menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-74445"}>
                                <a href="/marketing"><span>Products</span><img src="https://www.herold.at/ratgeber/wp-content/themes/herold_blog_theme_neu/img/angle-down.svg" alt="Arrow down" /></a>
                            ...
                            <li class="current-menu-item menu-item menu-item-type-post_type menu-item-object-page menu-item-home page_item page-item-53318 current_page_item menu-item-has-children menu-item-54512"><a target="_blank" rel="noopener" href="/about"><span>About Us</span>
                            </a>
                            </li>
