    ...
    return (
        <>
            <div className="default_header_wrapper__2Ml3A">
                <div>
                    <div className="header_header__2H2hK" style={{ position: 'fixed' }}>
                            ...
                            <div className="header_marketing_container__3yCxP">
                                <div className="header_marketing_wrapper__2xR8i">
                                    ...
                                    >
                                        <a
                                            className="button"
                                            href="https://www.herold.at/marketing/onlinecomplete/herold-sichtbarkeits-check/?utm_source=herold_at&utm_medium=top_banner&utm_campaign=herold_sichtbarkeitscheck"
                                        >
                                            <font style={{ verticalAlign: "inherit" }}>
                                ...
                                <button className="button_btn__3kzkB button_small__2KM-P button_secondary__s1GX9">
                                    <font style={{ verticalAlign: "inherit" }}>
