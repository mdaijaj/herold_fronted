...
export const ProductsFooterSection = () => {
    ...
    return (
        <>
            <footer>
                <a class="call-p alltel" href={`tel:${gradimoContact?.phone}`} style={{}} _msthidden="1">
                    <p _msttexthash="136305" _msthidden="1" _msthash="148">{gradimoContact?.phone}</p>
                </a>
                <a class="call alltel" href={`tel:${gradimoContact?.phone}`} style={{}} _mstvisible="0">
                ...
                <div class="block_1 question footer_block_question">
                    <div class="container" style={{ backgroundColor: gradimoAdviceNow?.color }}>
                        ...
                        <div class="secondary-button" id="secondary-button">
                            <a href="/advice-now" target="" _msttexthash="206570" _msthash="152">{gradimoAdviceNow?.buttom_name}</a>
                        </div>
                    </div>
                </div>
