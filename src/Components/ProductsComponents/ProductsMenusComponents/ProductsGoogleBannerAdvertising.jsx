...
import { ProductsGoogleBannerAdvertisingFirstViewRocket } from "./ProductsGoogleBannerAdvertisementComponents/ProductsGoogleBannerAdvertisingFirstViewRocket";
import { ProductsGoogleBannerAdvertisementCardSlider } from "./ProductsGoogleBannerAdvertisementComponents/ProductsGoogleBannerAdvertisementCardSlider";
import { ProductsGoogleBannerAdvertisementFirstQuestionBlock } from "./ProductsGoogleBannerAdvertisementComponents/ProductsGoogleBannerAdvertisementFirstQuestionBlock";
import { ProductsGoogleBannerAdvertisementFirstBlock } from "./ProductsGoogleBannerAdvertisementComponents/ProductsGoogleBannerAdvertisementFirstBlock";
import { ProductsGoogleBannerAdvertisementSecondBlock } from "./ProductsGoogleBannerAdvertisementComponents/ProductsGoogleBannerAdvertisementSecondBlock";
import { ProductsGoogleBannerAdvertisementOpacityBlock } from "./ProductsGoogleBannerAdvertisementComponents/ProductsGoogleBannerAdvertisementOpacityBlock";
import { ProductsGoogleBannerAdvertisementCitationBlock } from "./ProductsGoogleBannerAdvertisementComponents/ProductsGoogleBannerAdvertisementCitationBlock";
...
import { ProductsGoogleBannerAdvertisementRecommendedBlock } from "./ProductsGoogleBannerAdvertisementComponents/ProductsGoogleBannerAdvertisementRecommendedBlock";
import { ProductsFooterSection } from "../ProductsFooterSection";

export const ProductsGoogleBannerAdvertising = () => {
    ...
    useEffect(() => {
        ...
        link9.href = "/marketing/wp-content/themes/heroldmarketing/css/gba.css"
        link9.media = "all"
                ...
                <div className='site-main' id='primary'>
                    <article>
                        <div className='entry-content'>
                            <ProductsGoogleBannerAdvertisingFirstViewRocket />
                            <ProductsGoogleBannerAdvertisementCardSlider />
                            <ProductsGoogleBannerAdvertisementFirstQuestionBlock />
                            <ProductsGoogleBannerAdvertisementFirstBlock />
                            <ProductsGoogleBannerAdvertisementSecondBlock />
                            <ProductsGoogleBannerAdvertisementOpacityBlock />
                            <ProductsGoogleBannerAdvertisementCitationBlock />
                            <ProductsGoogleBannerAdvertisementConsultationBlock />
                            <ProductsGoogleBannerAdvertisementRecommendedBlock />
                        </div>
                    </article>
                </div>
                {/* <footer>
