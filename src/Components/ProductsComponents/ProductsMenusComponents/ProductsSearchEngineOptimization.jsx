...
import { ProductsSearchEngineOptimizationFirstViewRocket } from "./ProductsSearchEngineOptimization/ProductsSearchEngineOptimizationFirstViewRocket";
import { ProductsSearchEngineOptimizationCardSlider } from "./ProductsSearchEngineOptimization/ProductsSearchEngineOptimizationCardSlider";
import { ProductsSearchEngineOptimizationFirstQuestionBlock } from "./ProductsSearchEngineOptimization/ProductsSearchEngineOptimizationFirstQuestionBlock";
import { ProductsSearchEngineOptimizationFirstBlock } from "./ProductsSearchEngineOptimization/ProductsSearchEngineOptimizationFirstBlock";
import { ProductsSearchEngineOptimizationSecondBlock } from "./ProductsSearchEngineOptimization/ProductsSearchEngineOptimizationSecondBlock";
import { ProductsSearchEnginOptimizationOpacityBlock } from "./ProductsSearchEngineOptimization/ProductsSearchEngineOptimizationOpacityBlock";
import { ProductsSearchEngineOptimizationCitationBlock } from "./ProductsSearchEngineOptimization/ProductsSearchEngineOptimizationCitationBlock";
import { ProductsSearchEngineOptimizationFAQBlock } from "./ProductsSearchEngineOptimization/ProductsSearchEngineOptimizationFAQBlock";
import { ProductsSearchEngineOptimizationThirdBlock } from "./ProductsSearchEngineOptimization/ProductsSearchEngineOptimizationThirdBlock";
import { ProductsSearchEngineOptimizationSecondQuestionBlock } from "./ProductsSearchEngineOptimization/ProductsSearchEngineOptimizationSecondQuestionBlock";
import { ProductsSearchEngineOptimizationRecommendedBlock } from "./ProductsSearchEngineOptimization/ProductsSearchEngineOptimizationRecommendedBlock";
import { ProductsFooterSection } from "../ProductsFooterSection";
export const ProductsSearchEngineOptimization = () => {
    ...
    useEffect(() => {
        ...
        link9.href = "/marketing/wp-content/themes/heroldmarketing/css/seo.css"
        link9.media = "all"
                ...
                <div className='site-main' id='primary'>
                    <article>
                        <div className='entry-content'>
                            <ProductsSearchEngineOptimizationFirstViewRocket />
                            <ProductsSearchEngineOptimizationCardSlider />
                            <ProductsSearchEngineOptimizationFirstQuestionBlock />
                            <ProductsSearchEngineOptimizationFirstBlock />
                            <ProductsSearchEngineOptimizationSecondBlock />
                            <ProductsSearchEnginOptimizationOpacityBlock />
                            <ProductsSearchEngineOptimizationCitationBlock />
                            <ProductsSearchEngineOptimizationFAQBlock />
                            <ProductsSearchEngineOptimizationThirdBlock />
                            <ProductsSearchEngineOptimizationSecondQuestionBlock />
                            <ProductsSearchEngineOptimizationRecommendedBlock />
                        </div>
                    </article>
                </div>
