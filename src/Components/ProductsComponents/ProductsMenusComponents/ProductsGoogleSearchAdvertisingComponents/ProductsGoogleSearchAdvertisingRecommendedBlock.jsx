...
export const ProductsGoogleSearchAdvertisingRecommendedBlock = () => {
                        ...
                        <div className="block recommend">
                            ...
                            <div className="container card-slider slick-initialized slick-slider slick-dotted">
                                <div className="slick-list draggable">
                                    <div className="slick-track" style={index === 0 ? { opacity: 1, width: '2345px', transform: 'translate3d(-0px, 0px, 0px)' } : index === 1 ? { opacity: 1, width: '2345px', transform: 'translate3d(-340px, 0px, 0px)' } : { opacity: 1, width: '2345px', transform: 'translate3d(-670px, 0px, 0px)' }}>
                                        ...
                                        <div className="card-item slick-slide slick-cloned" style={{ width: '320px' }} tabIndex="-1" role="tabpanel">
