...
import { ProductsAdvertisingOnHeroldFirstViewRocket } from "./ProductsAdvertisingOnHeroldComponents/ProductsAdvertisingOnHeroldFirstViewRocket";
import { ProductsAdvertisementOnHeroldCardSlider } from "./ProductsAdvertisingOnHeroldComponents/ProductsAdvertisementOnHeroldCardSlider";
import { ProductsAdvertisementOnHeroldFirstQuestionBlock } from "./ProductsAdvertisingOnHeroldComponents/ProductsAdvertisementOnHeroldFirstQuestionBlock";
import { ProductsAdvertisementOnHeroldFirstBlock } from "./ProductsAdvertisingOnHeroldComponents/ProductsAdvertisementOnHeroldFirstBlock";
import { ProductsAdvertisementOnHeroldSecondBlock } from "./ProductsAdvertisingOnHeroldComponents/ProductsAdvertisementOnHeroldSecondBlock";
import { ProductsAdvertisementOnHeroldOpacityBlock } from "./ProductsAdvertisingOnHeroldComponents/ProductsAdvertisementOnHeroldOpacityBlock";
import { ProductsAdvertisementOnHeroldFAQBlock } from "./ProductsAdvertisingOnHeroldComponents/ProductsAdvertisementOnHeroldFAQBlock";
import { ProductsAdvertisementOnHeroldServiceBlock } from "./ProductsAdvertisingOnHeroldComponents/ProductsAdvertisementOnHeroldServiceBlock";
import { ProductsGoogleBannerAdvertisementConsultationBlock } from "./ProductsGoogleBannerAdvertisementComponents/ProductsGoogleBannerAdvertisementConsultationBlock";
import { ProductsAdvertisementOnHeroldConsultationBlock } from "./ProductsAdvertisingOnHeroldComponents/ProductsAdvertisementOnHeroldConsultationBlock";
import { ProductsAdvertisementOnHeroldRecommendedBlock } from "./ProductsAdvertisingOnHeroldComponents/ProductsAdvertisementOnHeroldRecommendedBlock";
import { ProductsFooterSection } from "../ProductsFooterSection";

export const ProductsAdvertisementOnHerold = () => {
    ...
    useEffect(() => {
        ...
        link9.href = "/marketing/wp-content/themes/heroldmarketing/css/aoh.css"
        link9.media = "all"
                ...
                <div className='site-main' id='primary'>
                    <article>
                        <div className='entry-content'>
                            <ProductsAdvertisingOnHeroldFirstViewRocket />
                            <ProductsAdvertisementOnHeroldCardSlider />
                            <ProductsAdvertisementOnHeroldFirstQuestionBlock />
                            <ProductsAdvertisementOnHeroldFirstBlock />
                            <ProductsAdvertisementOnHeroldSecondBlock />
                            <ProductsAdvertisementOnHeroldOpacityBlock />
                            <ProductsAdvertisementOnHeroldFAQBlock />
                            <ProductsAdvertisementOnHeroldServiceBlock />
                            <ProductsAdvertisementOnHeroldConsultationBlock />
                            <ProductsAdvertisementOnHeroldRecommendedBlock />
                        </div>
                    </article>
                </div>
                {/* <footer>
