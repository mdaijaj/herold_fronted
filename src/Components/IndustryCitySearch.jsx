...
import { IndustryCitySearchMain } from "./IndustryCitySearchComponents/IndustryCitySearchMain";
export const IndustryCitySearch = () => {
    const { setZipCodeList, setSpecificIndustryCompanyList, setRandomIndustries, setGradimoAdviceNow, setIndustryAZList, setCompanyNameOnly, setCompanyList, setSugCityList, setSugDistrictList, setCityOnly, setSpecificIndustryCityList, setSpecificIndustryList, setCityContent, productIdList, setCityList, setProductsList, counselerList, setCounselerIdList, counselerIdList, baseBackendRoute, setProductIdList, productsList, setCounselerList } = useContext(AppContext);
    const [isMobileMenuOpen, setMobileMenuOpen] = useState(false);
    const { city_only } = useParams();
