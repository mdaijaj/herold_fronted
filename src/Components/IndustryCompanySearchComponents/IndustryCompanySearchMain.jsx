...
import { IndustrySearchSection } from "./IndustrySearchSection";
export const IndustryCompanySearchMain = () => {
    const [first, setFirst] = useState(true);
    const [second, setSecond] = useState(false);
    const { company_only, city, industry } = useParams();
    const [show, setShow] = useState(false);
    const [third, setThird] = useState(false);
    const { specificIndustryList, baseBackendRoute, specificIndustryCompanyList, randomIndustries, specificIndustryCityList, industryAZList, companyNameOnly, cityOnly } = useContext(AppContext);
    useEffect(() => {
        console.log(specificIndustryCompanyList);
    }, [specificIndustryList, specificIndustryCompanyList, specificIndustryCityList, companyNameOnly])
    return (
        <>
                                        ...
                                        <div className="list-header_list_header_module__9Yh_6">
                                            <div className="list-header_heading__AMXVc">
                                                <h1 className="list-header_head__28oEb">
                                                    <font style={{ verticalAlign: "inherit" }}>
                                                        <font style={{ verticalAlign: "inherit" }}>
                                                            {companyNameOnly?.length} results found for {company_only}
                                                        </font>
                                                    </font>
                                                </h1>
                                                <div className="list-header_toggle_button__21W_S">
