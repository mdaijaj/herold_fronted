...
import { AdvisorGoogleAdsWidgetBreadcrumb } from "./AdvisorGoogleAdsComponents/AdvisorGoogleAdsWidgetBreadcrumb";
import { AdvisorGoogleAdsSidebar } from "./AdvisorGoogleAdsComponents/AdvisorGoogleAdsSidebar";
import { AdvisorGoogleAdsTutorialContent } from "./AdvisorGoogleAdsComponents/AdvisorGoogleAdsTutorialContent";

export const AdvisorGoogleAds = () => {
    useEffect(() => {
            ...
            <div id="page" className="site">
                ...
                <main id="primary" class="site-main test test">
                    <div className="container">
                        <AdvisorGoogleAdsWidgetBreadcrumb />
                        <div id="primary" className="content-area">
                            <main id="main" className="site-main" style={{ marginTop: "100px" }}>
                                <div className="container">
                                    <div className="grid-container">
                                        <AdvisorGoogleAdsSidebar />
                                        <AdvisorGoogleAdsTutorialContent />
                                    </div>
                                </div>
                            </main>
