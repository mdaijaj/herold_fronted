...
import { AdvisorEncGlosserSearch } from "./AdvisorEncComponents/AdvisorEncGlosserSearch";
import { AdvisorEncGlosserFilter } from "./AdvisorEncComponents/AdvisorEncGlosserFilter";
import { AdvisorEncEntriesGlosser } from "./AdvisorEncComponents/AdvisorEncEntriesGlosser";

export const AdvisorEnc = () => {
    useEffect(() => {
        ...
        document.body.classList.add("post-type-archive");
        document.body.classList.add("post-type-archive-ratgeber_glossar");
        document.body.classList.add("wp-custom-logo");
        document.body.classList.add("wp-embed-responsive");
        ...
        link = document.createElement("link");
        link.rel = "stylesheet";
        link.href = "/advisors/wp-content/cache/min/1/ratgeber/wp-content/themes/herold_blog_theme_neu/assets/css/stuts.css"
        link.type = "text/css";
        link.media = "all";
        head.appendChild(link);
        ...
        link = document.createElement("link");
        link.rel = "stylesheet";
        link.href = "/advisors/wp-content/cache/min/1/ratgeber/wp-content/plugins/gravityforms/css/basic.minac02.css"
        link.type = "text/css";
        link.media = "all";
        head.appendChild(link);
        ...
        link = document.createElement("link");
        link.rel = "stylesheet";
        link.href = "/advisors/wp-content/cache/min/1/ratgeber/wp-content/themes/herold_blog_theme_neu/glossar/glossar648a.css"
        link.type = "text/css";
        link.media = "all";
        head.appendChild(link);

        // /wp-content/cache/min/1/ratgeber/wp-content/themes/herold_blog_theme_neu/glossar/glossar.css
    ...
    return (
        <>
            <div id="page" className="site">
                ...
                <main role="main">
                    <div className="glossar-header">
                        <div className="first-view" style={{ backgroundImage: "url(https://www.herold.at/ratgeber/wp-content/uploads/2023/01/AdobeStock_555391189.jpg)" }}>
                            <div className="container">
                                <div className="title-head">
                                    <h1 _msttexthash="725491" _msthash="101">Online Marketing Encyclopedia</h1>
                                    <h2 _msttexthash="2852486" _msthash="102">The most important terms explained in a clear and understandable way</h2>
                                </div>
                                <AdvisorEncGlosserSearch />
                            </div>
                        </div>
                    </div>
                    <div className="glossar-wrapper">
                        <AdvisorEncGlosserFilter />
                        <hr />
                        <AdvisorEncEntriesGlosser />
                    </div>
                </main>
                <footer>
