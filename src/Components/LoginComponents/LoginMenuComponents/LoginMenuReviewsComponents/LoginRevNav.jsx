                    ...
                    <div className={`${Styles["row"]} ${Styles["titlebar"]} ${Styles["justify-content-between"]}`}>
                        <div className={Styles["d-flex"]}>
                            <a className={Styles["navbar-brand"]} href="/">
                                <img src="/images/herold_claim_right.svg" alt="gradimo-skupaj.si" title="gradimo-skupaj.si" _mstalt="3177642" _msthash="37" />
                            </a>
                        </div>
                        <div className={`${Styles["d-none"]} ${Styles["d-lg-flex"]}`}>
                            <ul className={`${Styles["nav"]} ${Styles["navbar-nav"]} ${Styles["navbar-desktop"]}`}>
                                ...
                                <li className={`${Styles["tab-REV"]} ${Styles["nav-item"]}`}>
                                    <a href="/bewertungen/" className={Styles["nav-link"]} title="Reviews at Gradimo Skupaj" data-action="click" data-category="Main Navigation" data-label="REV" _msttexthash="161044" _msthash="40">Reviews</a>
                                </li>
                                ...
                                <li className={`${Styles["tab-WERBEN"]} ${Styles["nav-item"]}`}>
                                    <a href="/marketing/" className={Styles["nav-link"]} target="_blank" rel="noopener" title="Products at gradimo skupaj" data-action="click" data-category="Main Navigation" data-label="WERBEN" _msttexthash="359749" _msthash="42">Business Solutions</a>
                                </li>
                                <li className={`${Styles["tab-login"]} ${Styles["nav-item"]} ${Styles["dropdown"]}`}>
                                    <a className={Styles["nav-link"]} id={Styles["dropdownLoginButton"]} href="javascript:void(0);" title="Bei Mein Herold anmelden" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" _msttexthash="113659" _msthash="43">Announce</a>
                        ...
                        <div class="d-none d-lg-flex">
                            <ul class="nav navbar-nav navbar-desktop">
                                ...
                                <li class="tab-WERBEN nav-item">
                                    <a href="/marketing" class="nav-link" target="_blank" rel="noopener" title="Products at gradimo skupaj" data-action="click" data-category="Main Navigation" data-label="WERBEN" _msttexthash="359749" _msthash="41">Business Solutions</a>
                                </li>
                    ...
                    <div class={show ? "row dropdown-menu collapse show" : "row dropdown-menu collapse"} id="navbar-md-down" _msthidden="6">
                        <ul class="nav navbar-nav" _mstvisible="1">
                            ...
                            <li class="tab-REV nav-item" _mstvisible="2">
                                <a href="/reviews" class="nav-link" title="Reviews at Gradimo Skupaj" data-action="click" data-category="Main Navigation" data-label="REV" _msttexthash="161044" _msthash="46" _mstvisible="3">Reviews</a>
                            </li>
                            ...
                            <li class="tab-WERBEN nav-item" _mstvisible="2">
                                <a href="/marketing" class="nav-link" target="_blank" rel="noopener" title="Products at gradimo skupaj" data-action="click" data-category="Main Navigation" data-label="WERBEN" _msttexthash="359749" _msthash="48" _mstvisible="3">Business Solutions</a>
                            </li>
