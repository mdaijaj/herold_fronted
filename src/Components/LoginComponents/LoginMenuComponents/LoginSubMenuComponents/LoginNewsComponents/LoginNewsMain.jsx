                ...
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div className="col-md-18">
                            <section id="tellAustria" className="row">
                                <div className="col-md-24">
                                    <h1>
                                        <font style={{ verticalAlign: "inherit" }}>
                                            <font style={{ verticalAlign: "inherit" }}>News from Austria</font>
                                        </font>
                                    </h1>
                                    <p className="mb-3">
                                        <font style={{ verticalAlign: "inherit" }}>
                                            <font style={{ verticalAlign: "inherit" }}>
                                                Here you will find all the latest news and offers from companies you
                                                follow on
                                            </font>
                                        </font>
                                        <a
                                        ...
                                        <font style={{ verticalAlign: "inherit" }}>
                                            <font style={{ verticalAlign: "inherit" }}>
                                                ...
                                                . Are you interested in news from other companies? Then search for
                                                them on
                                            </font>
                                        </font>
                                        <a
                                        ...
                                        <font style={{ verticalAlign: "inherit" }}>
                                            <font style={{ verticalAlign: "inherit" }}>
                                                ...
                                                and click on “Follow company” in the company entry!
                                            </font>
                                        </font>
                                    </p>
                                </div>
