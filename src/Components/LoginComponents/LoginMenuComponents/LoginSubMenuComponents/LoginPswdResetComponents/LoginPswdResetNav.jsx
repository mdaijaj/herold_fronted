...
export const LoginPswdResetNav = () => {
                    ...
                    <div className="row titlebar justify-content-between">
                        ...
                        <div className="d-none d-lg-flex">
                            <ul className="nav navbar-nav navbar-desktop">
                                ...
                                <li className="tab-usermenu nav-item dropdown">
                                    <a className="nav-link" id="dropdownUsermenuButton" href="javascript:void(0);" title="Show user menu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <div className="username"><font style={{ "vertical-align": "inherit" }}><font style={{ "vertical-align": "inherit" }}>			software developers48
                                        </font></font></div>
                                    ...
                                    <div className="dropdown-menu" aria-labelledby="dropdownUsermenuButton">
