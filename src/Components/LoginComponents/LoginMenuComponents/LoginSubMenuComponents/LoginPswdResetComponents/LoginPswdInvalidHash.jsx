...
export const LoginPswdInvalidHash = () => {
    useEffect(() => {
                    ...
                    <section id="register-success" className="register-confirm wrapper">
                        <div className="row">
                            <div className="col-24">
                                <div className="col-24">
                                    <h2 className="top"><font style={{ "vertical-align": "inherit" }}><font style={{ "vertical-align": "inherit" }}>Account has already been activated or could not be activated</font></font></h2>
                                </div>
