...
export const LoginGiveReviewNav = () => {
                        ...
                        <div className={`${Styles["d-none"]} ${Styles["d-lg-flex"]}`}>
                            <ul className={`${Styles["nav"]} ${Styles["navbar-nav"]} ${Styles["navbar-desktop"]}`}>
                                <li className={`${Styles["tab-YP"]} ${Styles["nav-item"]}`}>
                                    <a href="/" className={Styles["nav-link"]} title="Gelbe Seiten - Firmen- und Branchensuche" data-action="click" data-category="Main Navigation" data-label="YP" _msttexthash="136396" _msthash="38">Corporate</a>
                                </li>
                                ...
                                <li className={`${Styles["tab-REV"]} ${Styles["nav-item"]}`}>
                                    <a href="/bewertungen/" className={Styles["nav-link"]} title="Suchen in den herold.at Bewertungen" data-action="click" data-category="Main Navigation" data-label="REV" _msttexthash="161044" _msthash="40">Valuations</a>
                                </li>
                                <li className={`${Styles["tab-BLOG"]} ${Styles["nav-item"]}`}>
                                    <a href="/blog/" className={Styles["nav-link"]} title="Tipps aus der herold.at Redaktion" data-action="click" data-category="Main Navigation" data-label="BLOG" _msttexthash="43615" _msthash="41">Blog</a>
                                </li>
                                <li className={`${Styles["tab-WERBEN"]} ${Styles["nav-item"]}`}>
                                    <a href="/marketing/" className={Styles["nav-link"]} target="_blank" rel="noopener" title="Öffnet neues Fenster" data-action="click" data-category="Main Navigation" data-label="WERBEN" _msttexthash="359749" _msthash="42">Business Solutions</a>
                                </li>
